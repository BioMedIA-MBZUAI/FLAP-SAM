...
class Sam(nn.Module):
    ...
    def forward_train(self, batched_input, multimask_output, image_size):
        ...
        # image_embeddings = self.image_encoder(input_images, d_size) # uncomment this line and comment the above line to run MA-SAM
    ...
    def save_parameters(self) -> None:
        ...
        for key, value in state_dict.items():
            # if ("image_encoder" in key) and ("lora" in key):
    ...
    def load_parameters(self, filename: str) -> None:
        ...
        sam_dict = self.state_dict()
        image_encoder_new_state_dict = {}
        prompt_encoder_new_state_dict = {}
        mask_decoder_new_state_dict = {}
        for k in self.state_dict().keys():
            if k in state_dict.keys():
                if "image_encoder" in k:
                    image_encoder_new_state_dict[k] = state_dict[k]
                if "prompt_encoder" in k:
                    prompt_encoder_new_state_dict[k] = state_dict[k]
